...
class NovelBook extends StatefulWidget {
  const NovelBook({super.key});

  @override
  State<NovelBook> createState() => _NovelBookState();
}

class _NovelBookState extends State<NovelBook> {
  List<dynamic> _books = [];
  ...
  Future<void> getBooksFts() async {
    final response = await http.get(
        Uri.parse('https://www.googleapis.com/books/v1/volumes?q=novel'));
